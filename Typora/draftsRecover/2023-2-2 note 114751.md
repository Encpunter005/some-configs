...
* [STL](#stl)
  * [容器](#容器)
    ...
    * [unordered_set / unordered_map / unordered_multiset / unordered_multimap](#unordered_set-/-unordered_map-/-unordered_multiset-/-unordered_multimap)
    * [bitset](#bitset)
  * [库函数](#库函数)
...
* [数学知识](#数学知识)
  ...
  * [找最小公倍数](#找最小公倍数)
* [搜索与图论](#搜索与图论)
  * [DFS(深度优先搜索) && BFS(宽度优先搜索)](#dfs(深度优先搜索)-&&-bfs(宽度优先搜索))
  * [树与图(有向图)](#树与图(有向图))
    * [存储](#存储)
    * [深度优先遍历](#深度优先遍历)
    * [宽度优先遍历](#宽度优先遍历)
